...
export class DatagridBodyViewModel extends ViewModel {
  _draw_td(ridx, val, id, is_open, {
    ...
    if (selected_id !== false) {
      ...
      const is_sub_selected = !is_selected && isEqual(id === null || id === void 0 ? void 0 : id.slice(0, selected_id === null || selected_id === void 0 ? void 0 : selected_id.length), selected_id);

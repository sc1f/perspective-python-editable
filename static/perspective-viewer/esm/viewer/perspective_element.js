...
export class PerspectiveElement extends StateElement {
  ...
  async _load_table(table) {
    ...
    this._edit_port_id = await table.make_and_get_input_port(); // Resolve the edit port lock, which allows for `get_edit_port` to be
...
//# sourceMappingURL=perspective_element.js.map